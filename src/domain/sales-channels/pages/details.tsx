...
import ProductStatusSelector from '../../../components/molecules/status-selector';
...
function SalesChannelDetailsHeader(props: SalesChannelDetailsHeaderProps) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between">
      ...
      <div className="flex items-center justify-between gap-4 mb-base small:mb-0">
...
function Details() {
  ...
  return (
    <div>
      ...
      <div className="gap-x-xsmall flex flex-col gap-base small:grid small:grid-cols-3">
        <SalesChannelsList
          filterText={filterText}
          setFilterText={setFilterText}
          openCreateModal={openCreateModal}
