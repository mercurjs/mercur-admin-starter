              ...
              <div className="gap-y-xsmall flex flex-col">
                {fields.map((denomination, index) => {
                  return (
                    <div
                      key={denomination.id}
                      className="gap-x-base last:mb-large flex items-center border-b small:border-none pb-4 small:pb-0 small:items-end "
                    >
                      <CurrencyInput.Root
                        currentCurrency={store?.default_currency_code}
                        readOnly
                        size="medium"
                        className='flex-col gap-base !items-start small:items-center small:flex-row'
                      >
                        <Controller
                          control={control}
