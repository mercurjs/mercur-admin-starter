...
const PriceListPricesSection = ({ priceList }: PriceListPricesSectionProps) => {
  ...
  return (
    <Container className="p-0">
      <div className="flex flex-wrap gap-base items-center justify-between px-8 pt-6 pb-4">
        ...
        <div className="flex items-center gap-x-2">
          ...
          <DropdownMenu>
            <DropdownMenu.Trigger asChild>
              <IconButton>
                <EllipsisHorizontal className="shrink-0" />
              </IconButton>
      ...
      <div
        className="border-ui-border-base relative h-full flex-1 border-b overflow-x-scroll"
        style={{
          height: TABLE_HEIGHT,
        }}
      >
