        ...
        <div>
          {options.length > 0 && (
            <div className="mt-small">
              <div className="inter-small-semibold mb-small gap-x-xsmall text-grey-50 grid grid-cols-[1fr_1fr_40px] small:grid-cols-[230px_1fr_40px]">
              ...
              <div className="gap-y-xsmall grid grid-cols-1">
                {options.map((field, index) => {
                  return (
                    <div
                      key={field.fieldId}
                      className="gap-x-xsmall grid grid-cols-[70px_1fr_40px] small:grid-cols-[230px_1fr_40px]"
                    >
                      <InputField
