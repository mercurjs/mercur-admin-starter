  ...
  return (
    <FocusModal>
      ...
      <FocusModal.Main className="no-scrollbar flex w-full justify-center">
        <div className="small:w-4/5 medium:w-7/12 large:w-6/12 my-16 max-w-[700px] w-max">
          ...
          <div className="mb-8 flex flex-col small:flex-row justify-between gap-6">
            <InputField
              required
