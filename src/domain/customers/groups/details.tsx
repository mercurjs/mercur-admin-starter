...
function CustomersListPlaceholder() {
  ...
  return (
    <div className="center flex h-full min-h-[756px] items-center justify-center">
      <span className="text-xs text-gray-400">{t('groups-no-customers-in-this-group-yet', 'No customers in this group yet')}</span>
    </div>
  );
}
...
function CustomerGroupDetails() {
  ...
  return (
    <div className="-mt-4 pb-4">
      <BackButton path="/a/customers/groups" label={t('groups-back-to-customer-groups', 'Back to customer groups')} className="mb-4" />
