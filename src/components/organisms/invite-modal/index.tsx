        ...
        <Modal.Body>
          ...
          <Modal.Content>
            <div className="gap-y-base flex flex-col">
              <InputField label={t('invite-modal-email', 'Email')} placeholder="lebron@james.com" required {...register('user', { required: true })} />
              <Controller
                name="role"
                control={control}
                defaultValue={{
          ...
          <Modal.Footer>
            <div className="flex h-8 w-full justify-end">
              <Button variant="ghost" className="text-small mr-2 w-32 justify-center" size="large" type="button" onClick={handleClose}>
                {t('invite-modal-cancel', 'Cancel')}
              </Button>
              <Button loading={isLoading} disabled={isLoading} size="large" className="text-small w-32 justify-center" variant="primary">
