...
const GeneralForm = ({ form, requireHandle = true, isGiftCard }: Props) => {
  ...
  return (
    <div>
      <div className="gap-x-large mb-small grid grid-cols-1 gap-2 small:grid-cols-2">
        <InputField
          label="Title"
      ...
      <div className="gap-x-large mb-large grid grid-cols-1 gap-2 small:grid-cols-2">
        <InputField
          label="Handle"
          tooltipContent={
            !requireHandle
