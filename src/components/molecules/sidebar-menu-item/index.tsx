...
const SidebarMenuItem: React.FC<SidebarMenuItemProps> & {
  ...
  const styles =
    "group py-1.5 my-0.5 rounded-rounded flex text-grey-50 hover:bg-grey-10 items-center px-2 w-fit small:w-full";
    ...
    <Collapsible
      ...
      trigger={
        <NavLink className={classNameFn} to={pageLink}>
          ...
          <span className="group-[.is-active]:text-grey-90 ml-3 hidden small:inline-block">
            {text}
          </span>
          {isNew && (
