...
export default {
  ...
  store: {
    ...
    getStoreDetails(id) {
      const path = `/admin/store/details/${id}`;
      return medusaRequest("GET", path);
    },
    update(update) {
      const path = "/admin/store";
  ...
  productTags: {
    create(tag) {
      const path = "/admin/product-tags";
      return medusaRequest("POST", path, tag);
    },
    update(id, tag) {
      const path = `/admin/product-tags/${id}`;
      return medusaRequest("POST", path, tag);
    },
    delete(id) {
      const path = `/admin/product-tags/${id}`;
  ...
  bulkEdit: {
    users(data) {
      const path = "/admin/bulk-edit/users";
      return medusaRequest("POST", path, data);
    },
    products(data) {
      const path = "/admin/bulk-edit/products";
      return medusaRequest("POST", path, data);
    },
  },
  users: {
